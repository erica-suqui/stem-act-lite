...
* I can click the confirmation link in the email and set up my account  
* I am prompted "Would you like to add an event now?" with Yes/No options  
...
**US003** **Organizations**: As a returning trusted partner, I want to be able to reset my password swiftly through the admins so I can resume my activities 

* I can click forgot password if I forget my password  
* I should be sent a link to reset password if admins see I have locked out  
* I can reset the password once the link is clicked 
